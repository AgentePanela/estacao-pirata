...
notekeeper-program-desc = Um simples bloco de notas para guardar textos.

news-read-program-name = Boletim da estação
news-read-program-desc = Veja as ultimas noticias da estação.

crew-manifest-program-name = Manifesto da tripulação
crew-manifest-program-desc = Veja a lista de funcionarios da estação.
crew-manifest-cartridge-loading = Carregando...

net-probe-program-name = NetProbe
net-probe-program-desc = Veja as frequencias de dispostivos da estação.
...
log-probe-program-desc = Veja os registros de acesso das portas da estação.
